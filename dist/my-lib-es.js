...
import { defineComponent, computed, openBlock, createElementBlock, createElementVNode, onMounted, resolveComponent, normalizeClass, createVNode, createCommentVNode, renderSlot, ref, onUnmounted, watch, withModifiers, Fragment, renderList, toDisplayString, getCurrentInstance, normalizeStyle } from 'vue';
...
function render$9(_ctx, _cache, $props, $setup, $data, $options) {
  return openBlock(), createElementBlock("svg", _hoisted_1$3, [createElementVNode("use", {
...
function render$7(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  /* PROPS */
  , _hoisted_1$1), _ctx.optionShow ? (openBlock(), createElementBlock("div", _hoisted_2, [(openBlock(true), createElementBlock(Fragment, null, renderList(_ctx.options, function (item) {
    return openBlock(), createElementBlock("li", {
      key: "options.label",
      onClick: function onClick($event) {
        return _ctx.change(item);
      }
    }, toDisplayString(item.value), 9
    /* TEXT, PROPS */
    , _hoisted_3);
  }), 128
  /* KEYED_FRAGMENT */
...
export { script$8 as Button, script$9 as Icon, script$4 as MyAside, script$5 as MyCol, script$3 as MyContainer, script$2 as MyFooter, script$1 as MyHeader, script as MyMain, script$6 as MyRow, script$7 as Select };
